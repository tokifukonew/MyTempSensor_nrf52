...
typedef void (*ble_os_characteristic2_value_write_handler_t) (uint8_t characteristic2_value);
...
typedef struct
{
    ...
    ble_os_characteristic2_value_write_handler_t characteristic2_value_write_handler
}ble_os_t;
